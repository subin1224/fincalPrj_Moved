			...
			<form>
				...
				<div class="form col-lg-12 php-email-form " align="center">
					...
					<div class="form-group form-row row " align="left" style="display: inline-block; margin-left:123px;">
						<input type="text" class="form-control" name="key" style="width:600px;" placeholder="세대키를 입력해주세요">
					</div>
					
					<br><br>
					<div class="text-center ">
						<a href="<c:url value='/register/registerAgree.do'/>"> 페이지 이동 TEST !!! 후에 지울거임  </a>
