            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                            <h1 class="content-header-title float-left mb-0"><a href="<c:url value='/admin/adminLiving/adNotice.do'/>">일정등록으로이동</h1>
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">행정 관리 메인</h2>
                            ...
                            <div id="place-order" class="list-view product-checkout">
                                ...
                                <div class="checkout-items">
                                    ...
                                    <div class="card ecommerce-card">
                                        <div class="item-img">
                                            <a href="app-ecommerce-details.html">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/2.png" alt="img-placeholder" />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <div class="item-name">
                                    ...
                                    <div class="card ecommerce-card">
                                        <div class="item-img">
                                            <a href="app-ecommerce-details.html">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/3.png" alt="img-placeholder" />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <div class="item-name">
                                    ...
                                    <div class="card ecommerce-card">
                                        <div class="item-img">
                                            <a href="app-ecommerce-details.html">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/4.png" alt="img-placeholder" />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <div class="item-name">
                                    ...
                                    <div class="card ecommerce-card">
                                        <div class="item-img">
                                            <a href="app-ecommerce-details.html">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/5.png" alt="img-placeholder" />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <div class="item-name">
                                                <h6 class="mb-0">
                                                    <a href="app-ecommerce-details.html" class="text-body">Apple - MacBook Air짰 (Latest Model) - 13.3" Display - Silver</a>
                                                </h6>
                                                <span class="item-company">By <a href="javascript:void(0)" class="company-name">Apple</a></span>
                                                <div class="item-rating">
                                                    <ul class="unstyled-list list-inline">
                                    ...
                                    <div class="card ecommerce-card">
                                        <div class="item-img">
                                            <a href="app-ecommerce-details.html">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/6.png" alt="img-placeholder" />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <div class="item-name">
