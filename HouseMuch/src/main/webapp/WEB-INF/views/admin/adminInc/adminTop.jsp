            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><span class="menu-title text-truncate" data-i18n="eCommerce">부가시설 관리</span></a>
                    <ul class="menu-content">
                        ...
                        <!-- 행정2-3 : 부가시설목록 입주민뷰(작업용) -->
                        <li><a class="d-flex align-items-center" href="<c:url value='/livingCenter/addFacilityList.do'/>">
                        <i data-feather="circle"></i><span class="menu-item" data-i18n="Wish List">부가시설목록 입주민뷰(작업용)</span></a>
                        </li>
                        <!-- 행정2-3 : 부가시설 신청폼(작업용) -->
                        <li><a class="d-flex align-items-center" href="<c:url value='/livingCenter/applicationAdd.do'/>">
                        <i data-feather="circle"></i><span class="menu-item" data-i18n="Wish List">부가시설 신청폼(작업용)</span></a>
                        </li>
                    </ul>
                </li>
